...
class GridApplication:
    def __init__(self, master):
        ...
        tk.Label(button_r1_c1, text="Sugar Menu", font=("Arial", 12, "bold"), bg='lightgray', foreground="#1E1F22").pack()
        ...
        self.rm_circle_button = tk.Button(button_r8_c1, text="Remove Node", command=self.select_rm_circle_mode,
                                          background="#2B2D30", foreground="#1E1F22")
        ...
        tk.Label(button_r1_c2, text="Linkage Menu", font=("Arial", 12, "bold"), bg='lightgray', foreground="#1E1F22").pack()
        ...
        tk.Label(button_r1_c3, text="Analysis Tools", font=("Arial", 12, "bold"), bg='lightgray', foreground="#1E1F22").pack()
        ...
        tk.Label(button_r1_c4, text="Instructions and Log", font=("Arial", 12, "bold"), bg='lightgray', foreground="#1E1F22").pack()
